    ...
    <div className="footer" id="footer">
      ...
      <ul className="footer-links">
        <li className="social-link-list-items">
          <a href="mailto: singhkrishnakant3@gmail.com" target="_blank">
            <i className="fas fa-envelope"></i>
          </a>
        </li>
        <li className="social-link-list-items ">
          <a href="https://github.com/krishnakant01" target="_blank">
            <i className="fab fa-github"></i>
          </a>
        </li>
        <li className="social-link-list-items">
          <a href="https://twitter.com/krishnakant_01" target="_blank">
